...
class UpperTribunalBundlePreparerTest {
    ...
    void should_throw_error_for_reheard_rule_32_respondent_decision() {
        ...
        when(asylumCase.read(AsylumCaseFieldDefinition.FTPA_RESPONDENT_RJ_DECISION_OUTCOME_TYPE))
    ...
    void should_throw_error_for_reheard_rule_32_appellant_decision() {
        ...
        when(asylumCase.read(AsylumCaseFieldDefinition.FTPA_APPELLANT_RJ_DECISION_OUTCOME_TYPE))
            .thenReturn(Optional.of(FtpaResidentJudgeDecisionOutcomeType.REHEARD_RULE32.toString()));
